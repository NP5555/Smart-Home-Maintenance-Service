# Review package — Task 1 (no-git adaptation: full contents of touched files, not a diff)

## Files touched
- Created: packages/domain/src/bookingTransitions.ts
- Created: packages/domain/test/bookingTransitions.test.ts
- Modified: packages/domain/src/index.ts

## File: packages/domain/src/bookingTransitions.ts
```typescript
/**
...
## File: packages/domain/test/bookingTransitions.test.ts
```typescript
